...
object DefaultFeatureIndexFactory extends GeoMesaFeatureIndexFactory {
  ...
  private val available = Seq(S2Index, S3Index, XZ3Index, Z3Index, Z2Index, XZ2Index, IdIndex, AttributeIndex)
  ...
  override def create[T, U](ds: GeoMesaDataStore[_],
    ...
    val idx = (index.name, index.version) match {
      ...
      case (Z3Index.name, 1)  => Some(new Z3Index(ds, sft, geom3, dtg, index.mode))
